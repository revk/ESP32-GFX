...
#include "packgrey9.h"
     ...
     static char const
        sevensegchar[] = "0123456789-_\"',ACEFGHIJLNOPSU";
...
// Driver support
        ...
        static void gfx_busy_wait (const char *why)
        {
        ...
        static esp_err_t gfx_send_gfx (uint8_t page)
        {
        ...
        static __attribute__((unused)) esp_err_t gfx_command_bulk (const uint8_t * bulk)
        {                       // Bulk command
...
// support
        ...
        void gfx_draw (gfx_pos_t w, gfx_pos_t h, gfx_pos_t wm, gfx_pos_t hm, gfx_pos_t * xp, gfx_pos_t * yp)
        ...
        const uint8_t *gfx_pack (const uint8_t * data, uint8_t * lx, uint8_t * hx, uint8_t * ly, uint8_t * hy, uint8_t ppb)
        {                       // Pack range bytes
           if (!data)
           {                    // No range
              *lx = 1;
        ...
        static __attribute__((unused)) void gfx_block16 (gfx_pos_t x, gfx_pos_t y, gfx_pos_t w, gfx_pos_t h, const uint8_t * data)
...
// drawing
        ...
        void gfx_icon2 (gfx_pos_t w, gfx_pos_t h, const void *data)
        {                       // Icon, 2 bit packed
           gfx_pos_t x,
             y;
           gfx_draw (w, h, 0, 0, &x, &y);
        ...
        void gfx_7seg (int8_t size, const char *fmt, ...)
        ...
        void gfx_text_draw (int8_t size, uint8_t z, uint8_t blocky, const char *text)
        ...
        void gfx_blocky (int8_t size, const char *fmt, ...)
        ...
        void gfx_border (uint8_t border)
        {
           if (!gfx)
              return;
        ...
        void gfx_line (gfx_pos_t x1, gfx_pos_t y1, gfx_pos_t x2, gfx_pos_t y2, gfx_intensity_t l)
        {                       // Draw a line
           if (!gfx)
              return;
           gfx_pos_t dx = (x2 - x1),
